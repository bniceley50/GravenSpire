...
**Negative Control:** runner-local fake faction consequence enabled; expected result FAIL
**Result:** FAIL
...
- FAIL `no_faction_consequence_scene_object_present`
- PASS `no_faction_consequence_component_present`
- PASS `no_faction_consequence_event_present`
- FAIL `no_faction_consequence_event_fired`
- PASS `m5_vendor_reputation_discount_hook_absent`
- PASS `m5_vendor_faction_rank_goods_hook_absent`
- FAIL `no_faction_consequence_applied`
- PASS `runner_local_fake_faction_consequence_negative_control_tripped`
...
- runner_local_fake_faction_consequence_enabled=True
- faction_consequence_scene_objects=RunnerLocalFakeFactionConsequenceProbe
- faction_consequence_components=none
- faction_consequence_events=none
- runner_local_fake_faction_consequence_events=1
- vendor_reputation_discount_hook=False
- vendor_faction_rank_goods_hook=False
- no_faction_consequence_applied=False
