...
| `production/session-state/active.md:72`, `production/session-state/active.md:338` | Historical session extract | Session-state history preserves the T1-COMBAT-10 failure description; closure routing is intentionally not part of this batch. |
