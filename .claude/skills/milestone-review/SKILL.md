...
argument-hint: "[milestone-name|current] [--review full|lean|solo] [--dry-run]"
user-invocable: true
...
Produce a milestone progress and quality review that ties completed work, remaining scope, risks, QA status, and next planning actions together.
...
- current: infer current milestone
- milestone-name: review named milestone
- full: include cross-discipline deep review
...
- production/milestones/[milestone]/milestone-review-[YYYYMMDD].md
...
1. Identify milestone goals and completion criteria.
2. Compare planned versus completed stories, epics, QA evidence, bug status, content counts, and architecture/design blockers.
3. Separate delivery progress from quality/readiness.
4. Use Task reviews only in full mode for QA/producer/technical perspectives.
5. Write an evidence-backed verdict and next-milestone recommendations.
