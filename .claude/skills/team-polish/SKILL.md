...
argument-hint: "[feature or area to polish] [--dry-run]"
user-invocable: true
...
Coordinate performance, technical art, audio, QA, and implementation polish for a feature or area.
...
- production/team/polish/[slug]-polish-plan.md
- production/team/polish/[slug]-issue-list.md
- production/qa/evidence/polish-[slug]-checklist.md
...
3. Spawn only the roles that materially contribute to this request: performance-analyst, technical-artist, sound-designer, qa-tester, gameplay-programmer.
4. Synthesize specialist output into one coherent plan focused on measurable polish targets, performance budgets, presentation defects, audio/visual feedback, regression risk, and QA signoff evidence.
