...
argument-hint: "[UI feature description] [--dry-run]"
user-invocable: true
...
Coordinate UX spec, UI visual design, implementation, accessibility, review, and polish for a UI feature.
...
- production/team/ui/[slug]-ui-plan.md
- production/team/ui/[slug]-handoff.md
- production/qa/evidence/ui-[slug]-checklist.md
...
3. Spawn only the roles that materially contribute to this request: ux-designer, ui-designer, frontend-programmer, technical-artist, qa-tester.
4. Synthesize specialist output into one coherent plan focused on user flow, screen states, accessibility, visual hierarchy, implementation contracts, input/platform handling, and QA scenarios.
