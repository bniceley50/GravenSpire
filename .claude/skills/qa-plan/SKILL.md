...
argument-hint: "[sprint | feature: system-name | story: path] [--dry-run]"
user-invocable: true
...
Generate a QA test plan for a sprint, feature, system, or release scope from stories, GDDs, ADRs, bug history, and risk evidence.
...
- sprint: current sprint QA plan
- feature:<system-name>: feature QA plan
- release: release QA plan
...
- production/qa/plans/qa-plan-[scope]-[YYYYMMDD].md
...
1. Resolve test scope and collect acceptance criteria, risk areas, modified systems, known bugs, and required evidence.
2. Create test suites grouped by smoke, functional, regression, edge-case, accessibility, performance, localization, and platform as applicable.
3. Define pass/fail evidence requirements and owner/time expectations.
4. Do not mark QA complete or modify story statuses.
5. Write the plan and list missing prerequisites.
